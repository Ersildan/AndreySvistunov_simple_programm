...
button_clear = Button(root, text="CE", padx=42, pady=20, command=button_clear)
button_mul = Button(root, text="*", padx=45.5, pady=20, command=lambda: button_click())
button_div = Button(root, text="/", padx=45.5, pady=20, command=lambda: button_click())
